...
Estas tabelas foram mergidas para análise utilizando um código unívoco que identifica cada participante.
...
`r movim.tab.n[1]` participantes (`r format.pct(movim.tab.prop)[1]`) sentem dor em algum dos movimentos avalidos, enquanto `r movim.tab.n[2:4]` sentem dor em dois, três e quatro movimentos respectivamente (o que corresponde a `r format.pct(movim.tab.prop)[2:4]` do total, respectivamente).
