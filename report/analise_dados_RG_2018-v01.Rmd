...
`r local.tab.n[1]` participantes relataram sentir dor em um único local, enquanto `r local.tab.n[2:4]` sentem dor em dois, três e quatro locais respectivamente.
`r local.tab.n[5]` participantes sentem dor nos 5 locais.
