...
Os participantes foram perguntados sobre o nível de dedicação que eles praticam seu esporte: `r N.nivel["PROFISSIONAL"]` praticam no nível profissional, `r N.nivel["UNIVERSITÁRIO/ESCOLAR"]` no nível universitário/escolar e `r N.nivel["RECREACIONAL"]` praticam recreacionalmente.
...
- N de participantes em que a dor interfere na prática esportiva: `r interfere.tab.n[2]`
- % de participantes em que a dor interfere na prática esportiva: `r format.pct(interfere.tab.prop[2])`
- N de movimentos em que participantes sentem (1 movimento, a todos os 5 movimentos): `r movim.tab.n`
- % de movimentos em que participantes sentem (1 movimento, a todos os 5 movimentos): `r format.pct(movim.tab.prop)`
- N de locais em que participantes sentem (1 local, a todos os 5 locais): `r local.tab.n`
- % de locais em que participantes sentem (1 local, a todos os 5 locais): `r format.pct(local.tab.prop)`
