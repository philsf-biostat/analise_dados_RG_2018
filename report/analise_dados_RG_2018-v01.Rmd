...
`r local.tab.n[1]` (`r format.pct(local.tab.prop)[1]`) participantes relataram sentir dor em um único local, enquanto `r local.tab.n[2:4]` sentem dor em dois, três e quatro locais respectivamente (`r format.pct(local.tab.prop)[2:4]`).
...
`r movim.tab.n[1]` participantes (`r format.pct(movim.tab.prop)[1]`) sentem dor em algum dos movimentos avalidos, enquanto `r movim.tab.n[2:4]` sentem dor em dois, três e quatro movimentos respectivamente (`r format.pct(movim.tab.prop)[2:4]`).
