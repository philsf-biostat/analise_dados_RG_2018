...
Atletas atuantes no Brasil, os participantes são oriundos de `r length(UF)` estados brasileiros (`r UF`), e `r length(paises.ext)` países estrangeiros (`r paises.ext`).
