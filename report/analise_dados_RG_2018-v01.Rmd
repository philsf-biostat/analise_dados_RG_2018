...
`r movim.tab.n[1]` participantes sente dor em algum dos movimentos avalidos, enquanto `r movim.tab.n[2:4]` sentem dor em dois, três e quatro movimentos respectivamente.
`r movim.tab.n[5]` sentem dor nos cinco movimentos.
